...
<div id="page-content">
	<div class="tabs ui-tabs ui-widget ui-widget-content ui-corner-all">
		<ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
			 <li onclick="location.href='<?php U('sub/type/sub')?>'" <?php if($_GET['type']=='sub'||empty($_GET['type'])) echo 'class=" ui-tabs-active ui-state-active"';?>>
			...
			<li onclick="location.href='<?php U('sub/type/unsub')?>'" <?php if($_GET['type']=='unsub') echo 'class=" ui-tabs-active ui-state-active"';?>>
		...
		<div id="icon-only-tabs-<?php if($_GET['type']=='sub'||empty($_GET['type'])){ echo 1;}else{echo 2;}?>" aria-labelledby="ui-id-<?php if($_GET['type']=='area'){ echo 2;}else{echo 1;}?>" class="ui-tabs-panel ui-widget-content ui-corner-bottom" role="tabpanel" aria-expanded="false" aria-hidden="true" style="display: block;">
...
$(function () {
    $('#highcharts-4').highcharts({
        title: {
            text: '<?php if($field=='sub')echo "新增" ;echo '取消';?>关注人数统计',
...
<?php 
        ...
        series: [{
            name: '<?php if($field=='sub')echo "新增" ;echo '取消';?>关注人数',
            data: [
                   <?php 
                   foreach ($data1 as $k=>$v){
                   	echo $v[$field].',';
