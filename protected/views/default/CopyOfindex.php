        ...
        <div id="page-wrapper" class="main_page">
            <div id="page-header" class="clearfix">
               <div id="header-logo">
				...
				<div >
					<img width="36" src="<?php if(!empty(user()->headimg)){ echo user()->headimg;}else{ echo $this->assets()."/images/gravatar.jpg";} ?>" style="padding-right: 4px; border-radius: 180px; float: left; margin-top: 15px;">
					<lable style="width: 153px;  overflow: hidden;  text-overflow: ellipsis; height: 20px;float: left;line-height: -68px;margin-top: 22;" class="tooltip-button popover-button-default " data-content="&lt;div class=&apos;primary-bgpad10A&apos;&gt;当前登录账号为：<?php echo user()->nickname;?> (<?php echo user()->username;?>)&lt;/div&gt;" data-trigger="hover" data-placement="right">
