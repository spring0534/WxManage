...
<div style="padding-bottom: 10px">
		<a href="<?php echo $this->createUrl('/activity/admin')?>" class="btn medium primary-bg btn_back">
...
$this->widget('zii.widgets.grid.CGridView', array(
	...
	<button type="button" onclick="GetCheckbox();" class="btn medium primary-bg">删除所选</button>
	</td></tr>
			</tbody>
		</table>
	</div>
	...
	'columns'=>array(
		array(
			...
			'type'=>'raw',
			/*'footer'=>'<button type="button" onclick="GetCheckbox();" class="btn medium primary-bg">删除</button>',*/
			'htmlOptions'=>array(
				'width'=>'10',
