				...
				<div class="waiting panelContent">
					<div class="qrcodeContent" style="position: relative;">
						<div class="qrcodePanel">
							<img class="qrcode lightBorder" id="loginQrCode" style="width: 255px;border-radius: 5px; " src="http://api.k780.com:88/?app=qr.get&level=L&size=14&data=<?php echo WEB_URL.'/'.$akey;?>">
						</div>
					</div>
					<div class="info">
