 ...
 * @since 1.0
 */
class BCLinkPager extends CBasePager
{
	...
	public function init()
	{
		...
		if($this->prevPageLabel===null)
			$this->prevPageLabel=Yii::t('yii','&lt;');//前一页
		if($this->firstPageLabel===null)
			$this->firstPageLabel=Yii::t('yii','&lt;&lt; 第一页');//第一页 First
		if($this->lastPageLabel===null)
			$this->lastPageLabel=Yii::t('yii','最后一页 &gt;&gt;');//Last
		if($this->header===null)
	...
	protected function createPageButton($label,$page,$class,$hidden,$selected)
	{
		...
		return '<li class="'.$class.'">'.CHtml::link($label,$this->createPageUrl($page),array('class'=>'btn large ui-state-default')).'</li>';
	}
