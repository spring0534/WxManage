...
*/
(function(win) {
	var root = win.statics+'/js/', //在wind.js加载之前定义_GJ.JS_ROOT
		...
		alias = {
			...
			extbtn  		   :'ueditor/extbtn',
			calendar		   : 'calendar/calendar',
			calendar_len	   : 'calendar/lang/en',
        ...
        //CSS路径
		alias_css = {
			calendar_jscal2 : 'calendar/jscal2',
			calendar_radius: 'calendar/border-radius',
			calendar_win2k : 'calendar/win2k',
